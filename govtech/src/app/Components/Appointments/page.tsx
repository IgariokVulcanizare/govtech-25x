...
// Import your Navbar (update path as needed)
import Navbar from "../page"; // or wherever your Navbar is located
...
export default function AppointmentsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] font-sans relative">
      ...
      {/* 2) Some extra spacing below the Navbar */}
        ...
        <div className="relative mb-6">
          ...
          <div className="absolute top-0 right-0 flex items-center gap-4">
            <div className="flex items-center border border-gray-300 rounded-xl shadow-sm p-3 text-md">
              <FaRegClock className="mr-2 text-gray-700" />
              ...
              >
                ...
                <div className="flex flex-col md:flex-row w-full justify-between items-start gap-4">
                  ...
                  <div className="flex items-start gap-4">
                    <div
                      className={`doctor-avatar w-[150px] h-[150px] ${
                        (appt.doctorName === "Dr. Tacu Igor" ||
      ...
      {modalAppointment && (
        ...
        >
          ...
          >
            ...
            {/* Circular doctor photo in modal */}
            ...
            <div className="mt-4 border-t pt-4 bg-gray-50 pb-8 pl-6 rounded-md text-gray-600">
              ...
              <div className="mt-4">
                ...
                {modalAppointment.status === "Anulate" && modalAppointment.reason && (
